...
<div class="container" style="margin-top: 50px;">
    ...
    <form class="layui-form" action="/index.php/ContactUs/send" method="post" style="width: 50%;text-align: center;margin-left: 25%;">
...
<script type="text/javascript">
    var _CONTROLLER_ = '/index.php/ContactUs';
    var _ACTION_ = '/index.php/ContactUs/index';
    var _ROOT_ = '';
</script>
