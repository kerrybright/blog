...
<div class="container" style="margin-top: 50px;">
	...
	<?php if(is_array($yaowenList)): foreach($yaowenList as $key=>$yaowen): ?><div style="width:100%;min-width:800px;margin-top: 10px;height:90px;background-color: white">
			...
			<div style="width:90%;float: left;padding-top: 30px;padding-left: 20px;">
				<h1 style="font-size: 16px;font-weight: bolder"><a target="_blank" href="<?php echo ($yaowen['url']); ?>"><?php echo ($yaowen['title']); ?></a></h1>
				<p>
...
<script type="text/javascript">
    var _CONTROLLER_ = '/index.php/DailyPie';
    var _ACTION_ = '/index.php/DailyPie/yaowen';
    var _ROOT_ = '';
</script>
