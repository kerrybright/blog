    ...
    <div style="padding: 10px;">
        ...
        <table class="layui-table">
            ...
            <?php if(is_array($articleList)): foreach($articleList as $key=>$list): ?><tr>
                    ...
                    <td>
                        <a title="删除" href="javascript:;" onclick="user_del(this, 'id', '<?php echo ($list["article_id"]); ?>')" class="ml-5" style="text-decoration:none">
...
<script type="text/javascript">
    ...
    var _ACTION_ = '/index.php/Article/lists';
    var _ROOT_ = '';
</script>
